...
* [ ] Add project migration helpers for older project versions
* [ ] Add stronger validation and user-facing warnings for broken project files
...
* [ ] Rename tracks
* [ ] Replace selected track audio
* [ ] Add track metadata panel
...
* [ ] Profile track switching and waveform render performance
...
* [ ] Add warning when linked fragments have different lengths
* [ ] Add more precise editor affordances for dense fragment layouts
...
* [ ] Add visible snap indicator
* [ ] Add snap threshold setting in UI
...
* [ ] Further simplify Player mode layout for mobile
...
* [ ] Improve queue controls for small screens
* [ ] Add clearer warnings for empty queue / missing fragments
...
* [ ] Clean up old/global loop controls if queue runtime fully replaces them later
...
* [ ] Add warning when linked fragments differ in length
* [ ] Decide whether to keep linked-fragment crossfade long-term
* [ ] If kept, make linked-fragment controls clearer in UI
...
* [ ] Add autosave
* [ ] Add recent projects
* [ ] Add app-library/cache storage model

### Known experimental / imperfect areas

* [ ] Linked-fragment crossfade is usable but not perfectly seamless
* [ ] Waveform rendering can still feel slow on some track switches
* [ ] Waveform visual state is secondary to audio behavior in Player mode
* [ ] Large project bundles may become slow or memory-heavy
* [ ] No persistent app library/cache yet
...
* [ ] Further simplify linked-fragment audio code
* [ ] Move to bundler-based source layout
* [ ] Add automated tests for state/storage helpers
...
* [ ] Test local audio file import on Android
* [ ] Test persistent app storage
* [ ] Test large audio file handling
* [ ] Test project bundle import/export on Android
* [ ] Test audio focus/background behavior
* [ ] Design app library/cache system
* [ ] Avoid loading giant project bundles into memory every launch
